...
/**
 * `/onboarding/pairing/scan` — camera scan route. On a successful scan
 * of a /join#CODE URL, pre-fills the pairing form's store state and
 * navigates back to the form (which can then proceed to confirm).
 */
export function PairingScan() {
  ...
  return (
    <main className="mx-auto min-h-dvh w-full max-w-sm px-6 py-6">
      <Link to="/onboarding/pairing" aria-label="Back" className="text-2xl text-paper-soft">
        ←
      </Link>
