...
//   pnpm vitest run tests/lib/markdown/latex-rendering.diagnostic.test.ts
//
// To inspect the produced HTML for a single case:
//   pnpm vitest run tests/lib/markdown/latex-rendering.diagnostic.test.ts -t "07 — pmatrix"
...
const BUG_SNIPPET_SEPARATED = BUG_SNIPPET.split(
  /(?<=\$\$)\s+(?=[A-ZÄÖÜa-zäöü])|(?<=\$\$)\s+(?=\\\[)/g,
).join('\n\n');
...
const CASES: Case[] = [
  {
    id: '01-inline-basic',
    sentinel: 'Energie',
    src: String.raw`Die Energie ist \(E = mc^2\), und der goldene Schnitt ist \(\varphi = \frac{1 + \sqrt{5}}{2}\).`,
  },
  {
    id: '02-display-bracket',
    sentinel: null,
    src: String.raw`\[
a^2 + b^2 = c^2
\]`,
...
\]`,
  },
  {
    id: '21-inline-dollar',
    sentinel: 'Preis',
    src: 'Der Preis ist $5, aber die Formel ist $x^2 + y^2 = z^2$ im Text.',
  },
  {
    id: '22-escaped-dollar',
    sentinel: '19.99',
    src: String.raw`Dieser Text enthält einen Preis: \$19.99 und danach Inline-Math: \(x+1\).`,
  },
  {
    id: '23-list',
    sentinel: null,
    src: String.raw`1. Erste Formel:
...
2. Zweite Formel:
  ...
  },
  {
    id: '24-blockquote',
    sentinel: null,
    src: String.raw`> Wichtiges Theorem:
>
> \[
> a^2 + b^2 = c^2
> \]`,
  ...
  { id: '25-codefence', sentinel: 'E = mc^2', src: '```latex\n\\[\nE = mc^2\n\\]\n```' },
  {
    id: '26-inline-code',
    sentinel: 'Schreibe',
    src: 'Schreibe `\\(E = mc^2\\)` in den Chat, wenn du Inline-Math testen willst.',
  },
  { id: '27-adjacent-text', sentinel: 'Vorher', src: String.raw`Vorher\(x+y=z\)Nachher` },
  {
    id: '28-unicode',
    sentinel: 'Äpfel',
    src: String.raw`Äpfel, Öl und Übergrößen: \(\alpha + \beta = \gamma\). Emoji danach 🚀.`,
  },
  {
    id: '29-long-inline',
    sentinel: 'mitten',
    src: String.raw`Ein langer Inline-Ausdruck: \(f(x_1, x_2, \ldots, x_n) = \sum_{i=1}^{n} \alpha_i x_i^2 + \sum_{i=1}^{n}\sum_{j=1}^{n} \beta_{ij}x_ix_j + \gamma\) mitten im Satz.`,
  },
  {
    id: '30-long-display',
    sentinel: null,
...
Dieser Satz danach muss normal lesbar bleiben.`,
  ...
  {
    id: '34-unbalanced-brace',
    sentinel: 'normaler Text',
    src: String.raw`\[
\frac{1}{2
\]
...
Nach dem kaputten Block geht normaler Text weiter.`,
  ...
  {
    id: '35-unclosed-display',
    sentinel: 'verschwinden',
    src: String.raw`Hier beginnt ein kaputter Block:
\[
x^2 + y^2 = z^2
...
\]`,
  ...
  {
    id: '37-text-between',
    sentinel: 'Markdown-Fettdruck',
    src: String.raw`Erste Formel:
...
\]`,
  ...
  {
    id: '39-ampersand-outside-align',
    sentinel: 'Text danach',
    src: String.raw`\[
a & b
\]
...
\]`,
  ...
  {
    id: '44-unicode-math',
    sentinel: 'Inline Unicode',
    src: String.raw`Inline Unicode: ∑, ∫, √, π, λ. LaTeX dazu: \(\sum_i x_i = \lambda\).`,
  },
  {
    id: '45-mixed-realistic',
    sentinel: 'numerische Stabilität',
    src: String.raw`Hier ist die Idee:
...
const MUST_PASS_IDS = new Set([
  ...
  '04-quadratic',
  '05-sum-limit',
  '06-integral-infinity',
  '07-pmatrix-multiline',
  '08-pmatrix-oneline',
  '09-array',
  '10-cases',
  '11-aligned',
  ...
  '29-long-inline',
  '30-long-display',
  '36-multiple-back-to-back',
  '37-text-between',
  '40-markdown-specials',
  '41-nested-braces',
  '42-units',
  '43-color',
  '44-unicode-math',
  '45-mixed-realistic',
  '99-BUG-SNIPPET-as-posted',
  '99-BUG-SNIPPET-newline-separated',
  '99-BUG-SNIPPET-verbatim',
  '99-LLM-realistic-with-newlines',
]);
